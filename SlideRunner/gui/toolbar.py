...
def defineToolbar(self):
        ...
        self.ui.iconWand = QAction(QIcon(ARTWORK_DIR_NAME+"iconWand.png"),"Annotate with magic wand",self)
        ...
        self.ui.iconWand.setCheckable(True)
        ...
        self.ui.tb.addAction(self.ui.iconWand)
        ...
        self.ui.iconWand.triggered.connect(partial(self.setUIMode, UIMainMode.MODE_ANNOTATE_WAND))
